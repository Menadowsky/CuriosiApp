...
public class QuizActivity extends AppCompatActivity {
    ...
    int correcta = 0, incorrecta = 0, nocontestada = 0, promediof = 0;
    ...
    LoginActivity USUARIO_LOGUEADO;
    ...
    private void checkResults() {
        int correctas = 0, incorrectas = 0, nocontestadas = 0, promedio = 0;
        ...
        nocontestada = nocontestadas;

        promedio = (correctas * 100) / all_questions.length;
        promediof = promedio;
        ...
        String message =
                String.format("Correctas: %d\nIncorrectas: %d\nNo contestadas: %d\nPromedio: %d%%\n",
                        correctas, incorrectas, nocontestadas, promedio);
        ...
        builder.setPositiveButton(R.string.finish, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                valores.put(DBHelper.COLUMNA_CORRECTA, correcta);
                valores.put(DBHelper.COLUMNA_INCORRECTA, incorrecta);
                valores.put(DBHelper.COLUMNA_NOCONTESTADA, nocontestada);
                valores.put(DBHelper.COLUMNA_PROMEDIO, promediof);
                valores.put(DBHelper.COLUMNA_NOMBRE, rUSUARIO_LOGUEADO);

                db.insert(DBHelper.NOMBRE_TABLA_2, null, valores);
